...
License:	GPL2
Source0:	http://mirrors.ctan.org/systems/texlive/tlnet/archive/boisik.r%{version}.tar.xz
Source1:	http://mirrors.ctan.org/systems/texlive/tlnet/archive/boisik.doc.r%{version}.tar.xz
BuildArch:	noarch
